...
\begin{center}
\includegraphics[width=0.96\linewidth]{sample_cov_comparison.pdf}\\[1pt]
{\footnotesize Sample covariance at three ensemble sizes (Lorenz~96):
fewer samples $\Rightarrow$ noisier estimate $\Rightarrow$ unstable
inverse $\Rightarrow$ shrinkage required.}
\end{center}
\end{tcolorbox}
