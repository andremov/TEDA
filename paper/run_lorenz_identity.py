# -*- coding: utf-8 -*-
"""
Run ONLY Identity Shrinkage on Lorenz96 and merge into table_data.csv.

Usage:
    cd d:/thesis
    python paper/run_lorenz_identity.py
"""
...
METHOD_NAME = 'Identity Shrinkage'
...
def main():
    ...
    for Ne in ENSEMBLE_SIZES:
        ...
        for run_idx in range(N_RUNS):
            ...
            try:
                analysis = AnalysisEnKFDirectPrecisionShrinkageIdentity(model)
