# -*- coding: utf-8 -*-
"""
Run ONLY Eigenvalue Shrinkage on Lorenz96 and merge into table_data.csv.

Usage:
    cd d:/thesis
    python paper/run_lorenz_eigenvalue.py
"""
...
METHOD_NAME = 'Eigenvalue Shrinkage'
...
def main():
    ...
    for Ne in ENSEMBLE_SIZES:
        ...
        for run_idx in range(N_RUNS):
            ...
            try:
                analysis = AnalysisEnKFDirectPrecisionShrinkageEigenvalues(model)
