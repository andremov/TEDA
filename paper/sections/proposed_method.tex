...
\end{equation}
where $\sigma_i^2$ are the diagonal entries of $\mathbf{S}$. The factor of 2 mirrors the $2/N_\ell$ scaling of the cosmological target in Section~\ref{sec:precision_estimation}. This variant tests how much of the direct precision shrinkage performance depends on domain-specific target knowledge versus the general framework itself.
